...
import { getCompletedSurvey, getFeedback, getResult } from 'app/providers/router/routeConfig/routes';
...
const QuestionsPage: React.FC = () => {
  ...
  const { list: questionsList, error } = useAppSelector((state) => state.questions);
